...
include { CELLRANGER_IS_MULTIPLEXED         } from '../../modules/local/btcmodules/cellranger_is_multiplexed'
include { CELLRANGER_NON_MULTIPLEXED         } from '../../modules/local/btcmodules/cellranger_non_multiplexed'
...
include { CELLRANGER_PER_SAMPLE         } from '../../modules/local/btcmodules/cellranger_per_sample'
